...
import com.chenld.mycloudreader.adapter.MovieDetailAdapter;
import com.chenld.mycloudreader.base.BaseHeaderActivity;
import com.chenld.mycloudreader.bean.MovieDetailBean;
import com.chenld.mycloudreader.bean.moviechild.SubjectsBean;
import com.chenld.mycloudreader.databinding.ActivityOneMovieDetailBinding;
import com.chenld.mycloudreader.databinding.HeaderSlideShapeBinding;
...
//        ImgLoadUtil.showImg(bindingHeaderView.ivOnePhoto,subjectsBean.getImages().getLarge());
  ...
  //      WebViewActivity.loadUrl(OneMovieDetailActivity.this, mMoreUrl, mMovieName);
    ...
    /**
     * 启动OneMovieDetailActivity
     * @param context       上一级的activity或fragment的 context
     * @param positionData
     * @param imageView
     */
    public static void start(Activity context, SubjectsBean positionData, ImageView imageView) {
        ...
        //5.0以上才有的效果.过渡动画，即activity切换动画.图片动画显示出来
