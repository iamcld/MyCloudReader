...
import com.chenld.mycloudreader.adapter.EverydayAdapter;
...
import com.chenld.mycloudreader.databinding.FooterItemEverydayBinding;
import com.chenld.mycloudreader.databinding.FragmentEverydayBinding;
import com.chenld.mycloudreader.databinding.HeaderItemEverydayBinding;
...
import com.chenld.mycloudreader.model.EverydayModel;
import com.chenld.mycloudreader.utils.GlideImageLoader;
...
//        mLists = (ArrayList<List<AndroidBean>>) maCache.getAsObject(Constants.EVERYDAY_CONTENT);
        LogUtils.d("----mBannerImages: " + (mBannerImages == null));
        LogUtils.d("----mLists: " + (mLists == null));
...
//        DebugUtil.error("----222222 ");
    ...
    public void onResume() {
        ...
        LogUtils.d("-----EverydayFragment----onResume()");
        // 开始图片请求
    ...
    public void onPause() {
        super.onPause();
        LogUtils.d("-----EverydayFragment----onPause()");
    ...
    public void onDestroy() {
        super.onDestroy();
        LogUtils.d("--EverydayFragment   ----onDestroy");
    }
}
